                ...
                $stateProvider
                    ...
                    .state('app.application', {
                        ...
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load(['js/controllers/application.js']);
                                }]
                        }
                    })
                    .state('app.account', {
                    ...
                    .state('app.account_history', {
                        url: '/account/history?type',
                        templateUrl: 'tpl/account_history.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load(['js/controllers/account_history.js']);
                                }]
                        }
                    })
                    .state('integration', {
